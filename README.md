...
| [SBOM](docs/SBOM.md) | Software Bill of Materials listing all Python and Node.js dependencies with versions, CVE status, severity ratings, and impact assessment. Generated by `/generate-sbom` (→ Security Auditor). |
