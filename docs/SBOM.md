...
| --- | --- | --- | --- |
| `@tootallnate/once` | `@tootallnate/once` | low | @tootallnate/once vulnerable to Incorrect Control Flow Scoping |
| `http-proxy-agent` | `http-proxy-agent` | low | low |
| `jest-environment-jsdom` | `jest-environment-jsdom` | low | low |
| `jsdom` | `jsdom` | low | low |
