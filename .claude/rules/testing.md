...
## Test Suite — 589 total tests across 6 suites
...
| Skills + Agents | `tests/test_skills.py` | 291 | pytest (validates 18 commands + 10 agents) |
...
| `make test-skills` | Validate 18 slash commands + 10 agents |
